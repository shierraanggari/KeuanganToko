...
Public Class BarangMasuk
    ...
    Public Function AddBarangMasuk(barangId As String, quantity As String, dateBarang As String)
    ...
    Public Function UpdateBarangMasuk(barangMasukID As String, barangId As String, quantity As String, dateBarang As String)
        Try
            dbConn.ConnectionString = ConnectionString()
            dbConn.Open()
            sqlCommand.Connection = dbConn
    ...
    Public Function DeleteBarangMasuk(barangMasukId As String)
        Try
